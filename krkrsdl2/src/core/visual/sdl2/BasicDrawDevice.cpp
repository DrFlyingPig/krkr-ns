...
{
	// Diagnostic for the inherited prototype's multiple-manager extension.
	// Independent opaque managers do not constitute a composited layer tree.
	KRKRNS_LOG("[layer] add manager=%p device=%p existing=%u", (void*)manager,
		(void*)this, (unsigned)inherited::Managers.size());
