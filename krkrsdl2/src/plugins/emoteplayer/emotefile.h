...
struct eyeControl
{
    // Missing flags in older PSBs mean enabled, preserving the historical
    // runtime behaviour.  Newer E-mote data can explicitly disable the
    // controller or its automatic blink scheduler.
    bool enabled = true;
    ...
    std::minstd_rand randomEngine{0x454d4f54u};
